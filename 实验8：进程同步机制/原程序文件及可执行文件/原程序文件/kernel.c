...
//
char test_inf1[] = "p            ";
// test_inf1[1] = running_proc + '0';
// test_inf1[3] = semid + '0';
// test_inf1[5] = sem[semid].value + '5';
// test_inf1[7] = sem[semid].block_size + '0';
// Putstr(test_inf1);
void do_p(int semid)
{
	sem[semid].value -= 1;
...
char test_inf2[] = "v             ";
//  test_inf2[1] = running_proc + '0';
// 	test_inf2[3] = semid + '0';
// 	test_inf2[5] = sem[semid].value + '5';
// 	test_inf2[7] = sem[semid].block_size + '0';
// 	Putstr(test_inf2);
void do_v(int semid)
{
	sem[semid].value += 1;
	if(sem[semid].value <= 0)
	{
		...
		sem[semid].block_size -= 1;
		int i;
		for(i = 0; i < sem[semid].block_size; i++)
		{
